...
// Re-instating the static course list as requested to focus on navigation logic.
const courses = [
  {
    _id: 1,
    icon: "📐",
...
function CourseCard({ course }) {
  ...
  return (
    <div
      ...
      onClick={handleCourseClick} // Using the new click handler
    >
      <div
...
function Home() {
  ...
  return (
    ...
    >
      ...
      {/* App Bar - This part remains for the public-facing home page */}
      <header className="w-full h-20 flex items-center px-12 py-2 bg-white shadow relative z-10">
        ...
        <div className="flex gap-9 text-lg font-semibold ml-3">
          <button
            onClick={handleCoursesClickInNav}
      ...
      {/* Featured Courses */}
      <section id="courses-section" className="w-full pb-14 bg-transparent relative z-10">
